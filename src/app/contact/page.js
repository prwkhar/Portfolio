...
export default function Contact() {
  ...
  return (
    <div className="relative py-24 px-6 min-h-screen bg-gradient-to-br from-[#0f2027] via-[#203a43] to-[#2c5364] text-white flex items-center justify-center overflow-hidden">
